...
if($ref !== 'http://sh.st/ZOzrl') {
  die("<br><br><font color='red'><center><h1>Sorry To Inform You Direct Access Is Not  Allowed First Go To The<br><a href=http://www.tricksrobo.com>www.TricksRobo.com</h1></a></center></font>");
}
...
<html ng-app="app" >
	<head>
		<title ng-bind="state.Stats.Title">TricksRobo</title>
	...
	<body class="app"><div ng-cloak class="cage">
		...
		<div class="title">
			<h2>
				<a href="http://pkworld.org/torrent"
					target="_blank"
		...
		<footer>
			<span>Made with love by 31K |<a href="http://www.Tricksrobo.com" target="_blank">TricksRobo</a></span>
